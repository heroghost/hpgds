...
class Pinyin
{
    ...
    private static $specialDic = array(
        '重庆市'=>array('cqs','chongqingshi'),
        '重庆'=>array('cqs','chongqing'),
        '厦门市'=>array('cqs','xiamenshi'),
        '厦门'=>array('cqs','xiamen'),
    );
    /**
     * 字符串拆分成单个字的数组
    ...
    {
        if(self::$specialDic[$string]) {
            self::$pinyin = self::$specialDic[$string][1];
            self::$short_pinyin = self::$specialDic[$string][0];
            return self::$pinyin;
        }
