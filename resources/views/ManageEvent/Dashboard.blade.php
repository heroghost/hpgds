            ...
            <div class="panel panel-success hide">
                ...
                <div class="panel-body">
                    ...
                    <a href="" class="btn-link btn">
                        修改活动页面设计 <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        创建门票 <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        网站嵌入代码 <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        生成代销链接 <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        编辑组织者费用 <i class="ico ico-arrow-right3"></i>
                    </a>
                </div>
