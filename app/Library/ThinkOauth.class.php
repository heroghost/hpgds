...
abstract class ThinkOauth{
    ...
    public static function getInstance($type, $token = null) {
    	...
    	require_once "thinksdk/{$name}.class.php";
	 ...
	 * 请求code 
	 */
	public function getRequestCodeURL($clientIdName = 'client_id', $moreparams = null){
		$this->config();
		//Oauth 标准参数
		$params = array(
			$clientIdName     => $this->AppKey,
	 ...
	 */
	public function getAccessToken($code, $extend = null, $cliendIdName = 'client_id', $secretName = 'client_secret'){
		$this->config();
		$params = array(
				$cliendIdName     => $this->AppKey,
				$secretName => $this->AppSecret,
