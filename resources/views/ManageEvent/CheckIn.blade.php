            ...
            <div class="col-md-12">
                <div class="attendee_input_wrap">
                    <div class="input-group">
                                 ...
                                 <button @click="showQrModal" title="扫描二维码" class="btn btn-default qr_search" type="button"><i
                    ...
                    'class' => 'form-control attendee_search',
                            ...
                            'placeholder' => '根据参与者名称、订单编号、参与者编号... 查询'
                ])  !!}
            ...
            <div class="col-md-12">
                <div class="attendee_list">
                    ...
                    <ul v-if="searchResultsCount > 0" class="list-group" id="attendee_list" v-cloak>
                        ...
                        >
                        名称: <b>@{{ attendee.first_name }} @{{ attendee.last_name }} </b> &nbsp; <span v-if="!attendee.is_payment_received" class="label label-danger">等待付款</span>
                        <br>
                        编号: <b>@{{ attendee.order_reference + '-' + attendee.reference_index }}</b>
                        <br>
                        门票: <b>@{{ attendee.ticket }}</b>
...
<div role="dialog" id="QrModal" class="scannerModal" v-show="showScannerModal" v-cloak>
    <div class="scannerModalContent">
        ...
        <div class="ScanResultMessage">
                    ...
                    <span v-else>
                        <div id="scanning-ellipsis">正在扫描<span>.</span><span>.</span><span>.</span></div>
                    </span>
        </div>
