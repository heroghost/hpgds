    ...
    <div class="col-md-9">
        <div class="btn-toolbar">
            <div class="btn-group btn-group-responsive">
                <a href="#" data-modal-id="CreateEvent" data-href="{{route('showCreateEvent', ['organiser_id' => @$organiser->id])}}" class="btn btn-success loadModal"><i class="ico-plus"></i> 创建活动</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        ...
        <div class="input-group">
            <input name="q" value="{{$search['q'] or ''}}" placeholder="查询活动.." type="text" class="form-control">
